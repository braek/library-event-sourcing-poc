...
open class EventStoreRecord() : UpdatableRecordImpl<EventStoreRecord>(EventStore.EVENT_STORE), Record6<UUID?, Long?, OffsetDateTime?, String?, JSONB?, Array<String?>?> {
    ...
    override fun field3(): Field<OffsetDateTime?> = EventStore.EVENT_STORE.OCCURRED_ON
    override fun field4(): Field<String?> = EventStore.EVENT_STORE.TYPE
    override fun field5(): Field<JSONB?> = EventStore.EVENT_STORE.PAYLOAD
    ...
    override fun value4(value: String?): EventStoreRecord {
        this.type = value
        return this
    }

    override fun value5(value: JSONB?): EventStoreRecord {
        this.payload = value
        return this
    }
    ...
    override fun values(value1: UUID?, value2: Long?, value3: OffsetDateTime?, value4: String?, value5: JSONB?, value6: Array<String?>?): EventStoreRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)

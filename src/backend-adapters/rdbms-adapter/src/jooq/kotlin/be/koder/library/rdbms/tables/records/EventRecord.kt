...
open class EventRecord() : UpdatableRecordImpl<EventRecord>(Event.EVENT), Record5<UUID?, Long?, OffsetDateTime?, String?, JSONB?> {
    ...
    override fun fieldsRow(): Row5<UUID?, Long?, OffsetDateTime?, String?, JSONB?> = super.fieldsRow() as Row5<UUID?, Long?, OffsetDateTime?, String?, JSONB?>
    override fun valuesRow(): Row5<UUID?, Long?, OffsetDateTime?, String?, JSONB?> = super.valuesRow() as Row5<UUID?, Long?, OffsetDateTime?, String?, JSONB?>
    ...
    override fun values(value1: UUID?, value2: Long?, value3: OffsetDateTime?, value4: String?, value5: JSONB?): EventRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: UUID? = null, sequenceId: Long? = null, occurredOn: OffsetDateTime? = null, type: String? = null, payload: JSONB? = null): this() {
        this.id = id
